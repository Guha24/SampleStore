    ...
    document.querySelectorAll('.js-update-link')
      .forEach((link)=>{
        link.addEventListener('click',()=>{
          ...
          container.classList.add('is-next-edit');
        });
    ...
    document.querySelectorAll('.js-save-quantity')
      .forEach((link)=>{
        link.addEventListener('click',()=>{
          ...
          const qty=Number(container.querySelector('.quantity-input').value);
          const sel=document.querySelector('.js-quantity-label')
          sel.innerHTML=qty;

          updateQuantity(productId,qty);
          container.classList.remove('is-editing-quantity');
          container.classList.remove('is-next-edit');
          updateCheckoutQuantity();
          renderPaymentSummary();
          renderOrderSummary();
      ...
      document.querySelectorAll('.quantity-input')
        .forEach((link)=>{
          ...
          if(event.key === 'Enter'){
            document.querySelector('.js-quantity-label').innerHTML=qty;
            updateQuantity(productId,qty);
            container.classList.remove('is-editing-quantity');
            container.classList.remove('is-next-edit');
            updateCheckoutQuantity();
